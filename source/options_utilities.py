...
def parse_options_and_input(version):
    ...
    parser.add_argument('-1', '--neighborhood',     action='store_true', help='(optional) For plotting show 1-neighborhood of selected nodes (include all direct neighbors).')
    parser.add_argument('-q', '--quiet',            action='store_true', help='(optional) Prevent printing of warning messages.')
    ...
    neighborhood_size = 1 if args.neighborhood else 0
    return [graph, args.statistics, args.vertical_layout, description_capable, descriptions_file, args.case_insensitive, args.plot, args.quiet, neighborhood_size]
